        ...
        <div id="left-body-area">
            ...
            <div id="user-menu">
                <ul id="left-user-menu-list">
                    ...
                    <li><a  href="">스크랩</a>
                        <ul id="myscrap-list">
                            <li><a  href="" class="myboard-list-in" style="color: #1e90ff;">레시피</a></li>
                            <li><a  href="" class="myboard-list-in">게시글</a></li>
                            <li><a  href="" class="myboard-list-in">상품</a></li>
                        </ul>
                    </li>
                    <li><a  href="">좋아요</a></li>
            ...
            <div id="scrap-area">
                ...
                <div id="scrap-area-content">
					...
					<c:forEach begin="1" end="8" step="1">
                        ...
                        <div class="scrap-img">
                            <img src="${contextPath}/resources/dummyImg/shopping/recipe1.png" alt="">
                        </div>
