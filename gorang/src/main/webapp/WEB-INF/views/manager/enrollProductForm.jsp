    ...
    <div id="main-container">
        ...
        <div id="left-container">
            <div id="product-management-list" class="management-list">
                ...
                <div class="list">
                    <div id="enroll-product" style="color: #1e90ff;" onclick="location.href='${contextPath }/enrollproduct.ma'">상품 등록</div>
        ...
        <div id="right-container">
                ...
                <div class="searchbar-container">
                    <div class="searchbar">
                        <div class="search-input-container">
                            ...
                            <input id="search-category-input" class="search-input" type="text" placeholder="카테고리명 입력">
                        </div>
            ...
            <div id="category-container" class="enroll-div-container">
                ...
                <div id="search-product-name-container">
                    ...
                    <div class="searchbar-container">
                        <div class="searchbar">
                            <div class="search-input-container">
                                <input id="search-product-name-input" class="search-input" type="text" placeholder="상품명 입력(브랜드명 + 제품명)">
                            </div>
                            <div class="search-btn-container">
                ...
                <div id="insert-product-price-area">
                    <div class="insert-product-price"> 
                        ...
                        <div class="price-input-container">
                            <input id="origin-price" class="price-input" type="text">원
                        </div>
                    </div>
                    ...
                    <div class="insert-product-price"> 
                        <div>판매가</div>
                        <div class="price-input-container">
                            <input id="saled-price" class="price-input" ype="text">원
                        </div>
                    </div>
                    <div class="insert-product-price"> 
                        <div>할인율</div>
                        <div class="price-input-container">
                            <input id="discount-percent" class="price-input" type="text">%
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="enroll-div-container">
                <button id="enroll-product-btn">등록</button>
            </div>
