            ...
            <div id="recently-seen-div">
                <button class="button-arrow" id="button-arrow-top">
                    <svg width="16" height="10" viewBox="0 0 16 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect x="2.31445" y="7.46094" width="7.72042" height="1.54408"
                            transform="rotate(-45 2.31445 7.46094)" fill="#D9D9D9" />
                        <rect width="7.72042" height="1.54408"
                            transform="matrix(-0.707107 -0.707107 -0.707107 0.707107 13.416 7.46094)" fill="#D9D9D9" />
                    </svg>
                </button>
                <div id="recently-seen-container">
                    ...
                    <ul>
                        <li>
                            <img src="${pageContext.request.contextPath}/resources/dummyImg/recipe/recipeMain/sidebarThumbnail1.png"
                                alt="">
                        </li>
                        <li>
                            <img src="${pageContext.request.contextPath}/resources/dummyImg/recipe/recipeMain/sidebarThumbnail2.png"
                                alt="">
                        </li>
                        <li>
                            <img src="${pageContext.request.contextPath}/resources/dummyImg/recipe/recipeMain/sidebarThumbnail3.png"
                                alt="">
                        </li>
                    </ul>
                </div>
                <button class="button-arrow" id="button-arrow-bottom">
                    <svg width="16" height="10" viewBox="0 0 16 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect width="7.72042" height="1.54408"
                            transform="matrix(0.707107 0.707107 0.707107 -0.707107 2.31445 2.53906)" fill="#D9D9D9" />
                        <rect x="13.6855" y="2.53906" width="7.72042" height="1.54408"
                            transform="rotate(135 13.6855 2.53906)" fill="#D9D9D9" />
                    </svg>
                </button>
            </div>
        </div>
